...
public class CycleViewPager extends FrameLayout
    ...
    private List<CycleViewInfo> infos;//数据集合
    ...
    public void setData(List<CycleViewInfo> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<CycleViewInfo> list, ImageCycleViewListener listener, int showPosition) {
